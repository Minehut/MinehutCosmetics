        ...
        Bukkit.getScheduler().runTaskAsynchronously(Cosmetics.get(), () -> {
            ...
            final Book emojiBook = Book.book(Component.text("Emojis"), Component.text("Emojis"),
                    Component.text()
                            ...
                            .append(Component.newline())
                            .append(Component.newline())
                            .append(Component.text("Get More Emojis ⬈").style(Style.style(NamedTextColor.BLUE, TextDecoration.UNDERLINED)).clickEvent(ClickEvent.openUrl("https://bit.ly/3TGDqMi")))
                            .append(Component.newline())
                            .append(Component.newline())
                            .append(Component.newline())
                            .append(Component.newline())
                            ...
                            .append(Component.text()
                                    ...
                                    .append(Component.text("Support for /ad and /msg will be added in a future update.").color(NamedTextColor.GRAY))
                            )
                            .build()
            );
