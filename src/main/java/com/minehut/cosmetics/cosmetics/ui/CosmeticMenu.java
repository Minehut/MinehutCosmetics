...
public class CosmeticMenu extends Menu {
    ...
    private static final Supplier<ItemStack> SKIN_INFO = ItemBuilder.of(Material.PLAYER_HEAD)
            .display(
                    Component.text("How to apply skins.", NamedTextColor.AQUA).decoration(TextDecoration.ITALIC, false))
            .lore(
                    Component.empty(),
    ...
    private static final Supplier<ItemStack> EMOJI_ICON = ItemBuilder.of(Material.PLAYER_HEAD)
            ...
            .skullTexture(
                    "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNDgxN2E3OTA5ODBhZDAwMmIzMTlmZWI2OTU2N2EwNmEwMjE1NGJhOWFjNDY5OTNkNWNmZDYyMDEwZTBmODNjYiJ9fX0=")
            .supplier();
    ...
    private static final Supplier<ItemStack> CRATE_ICON = ItemBuilder.of(Material.IRON_INGOT)
            ...
            .lore(Component.empty(),
                    Component.text("Open crates!").color(Collection.VALENTINES_2023.display().color())
    ...
    private static final Component EQUIPMENT_SKIN_MESSAGE = Component.text()
            ...
            .append(Component.newline())
            .append(Component.text("Hold the item you'd like to skin and type ").color(NamedTextColor.AQUA)
                    .append(Component.text("/skin").color(NamedTextColor.GOLD).decorate(TextDecoration.BOLD)))
            .append(Component.newline())
            .build();
