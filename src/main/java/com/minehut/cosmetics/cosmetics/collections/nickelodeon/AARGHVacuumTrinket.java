...
public class AARGHVacuumTrinket extends ItemTrinket {
    public AARGHVacuumTrinket() {
        super(Trinket.AARGH_VACCUUM.name());
    }

    @Override
    public Component name() {
        return Component.text("AARGH! Vaccuum")
    ...
    public @NotNull ItemStack menuIcon() {
        return ItemBuilder.of(Material.SCUTE)
            .display(name())
            .modelData(Model.Trinket.AARGH_VACCUUM)
            .build();
    }
