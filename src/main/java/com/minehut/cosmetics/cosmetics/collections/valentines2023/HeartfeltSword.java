...
public class HeartfeltSword extends ItemCosmetic {
    public HeartfeltSword() {
        super(Item.VALENTINE_SWORD.name());
    }

    @Override
    public Component name() {
        return Component.text("Heartfelt Sword")
    ...
    public @NotNull ItemStack menuIcon() {
        return ItemBuilder.of(Material.DIAMOND_SWORD)
            ...
            .modelData(Model.Item.Sword.VALENTINE)
            .build();
    }
